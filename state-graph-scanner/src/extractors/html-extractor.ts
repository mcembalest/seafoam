...
import { UIElement } from '../types.js';
...
function buildSelector($elem: cheerio.Cheerio<any>): string {
  // Prefer ID
...
function extractAttributes($elem: cheerio.Cheerio<any>): Record<string, string> {
